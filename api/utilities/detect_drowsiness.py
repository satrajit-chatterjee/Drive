...
def func(imgResp):
    global FRAME_COUNTER, COUNTER, EYE_AR_THRESH, EYE_AR_CONSEC_FRAMES, ALARM_ON, frame, thread_flag
    ...
    FRAME_COUNTER += 1
    print("Iteration Count", FRAME_COUNTER)
    ...
    for rect in rects:
        ...
        cv2.drawContours(frame, [leftEyeHull], -1, (233, 193, 133), 1)
        cv2.drawContours(frame, [rightEyeHull], -1, (233, 193, 133), 1)
        ...
        cv2.putText(frame, "EAR: {:.2f}".format(ear), (300, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (51, 118, 220), 2)

        # show the frame and send data to app
        # message = str(ear) + "," + ALARM_ON
        print("EAR: ", ear)
        print("Alarm status: ", ALARM_ON)
        message = {'EAR': ear, "ALARM": ALARM_ON}  # converting to JSON
        """
